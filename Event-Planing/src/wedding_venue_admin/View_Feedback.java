...
public class View_Feedback {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Feedback window = new View_Feedback();
	...
	private void initialize() {
		...
		JLabel lblAddVenue = new JLabel("VIEW FEEDBACK");
		...
		btnView.setBounds(31, 183, 132, 31);
