...
public class View_Booking {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_Booking window = new View_Booking();
	...
	private void initialize() {
		...
		btnLogout.setBounds(821, 20, 171, 35);
		...
		JLabel lblAddVenue = new JLabel("VIEW BOOKING");
			...
			public void actionPerformed(ActionEvent ae) {
				if(ae.getSource()== btnView){
					try{
						...
						String query="select * from book_venue";
		...
		btnView.setBounds(30, 184, 132, 31);
